...
<ul class="main-menu">
    ...
    <li class="active"><a href="http://localhost/basic/web/index.php?r=site/menusalat">Салаты</a></li>
	...
	<div class="container-fluid bg-trasparent my-4 p-3"> 
			...
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/овощной.png" class="card-img-top" alt="...">  
							<div class="card-body"> 
						<div class="text-center my-4">
							<h5 class="card-title">Овощной салат</h5> 
						</div>
						<div class="text-center my-4">
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/цезарь.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
				...
				<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/цезарьскрев.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Цезарь с креветками</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">99 рублей</span> 
