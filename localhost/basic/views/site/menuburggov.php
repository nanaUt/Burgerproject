...
<ul class="main-menu">
	...
	<li><a href="http://localhost/basic/web/index.php?r=site/menusouce">Соусы</a></li> 
</ul>
		...
		<div class="row g-3"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/биг спешиал три сыра.png" class="card-img-top" alt="...">  
							<div class="card-body"> 
						<div class="text-center my-4">
							<h5 class="card-title">Биг Спешиал Три сыра</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">299 рублей</span> 
						</div>
						</div>
			</div> 
		</div> 
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/биг спешиал джуниор.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Биг спешиал Джуниор</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">220 рублей</span> 
						</div>
						</div>  
		</div>
			</div>
				...
				<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/гранд де люкс.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Гранд Де Люкс</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">195 рублей</span> 
						</div>
						</div>
			</div> 
		</div> 
	...
	<div class="container-fluid bg-trasparent my-4 p-3"> 
		<div class="row g-3"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/гранд.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Гранд</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">169 рублей</span> 
						</div>
						</div> 
			</div> 
		</div> 
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/двойной гранд.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Двойной гранд</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">250 рублей</span> 
						</div>
						</div>
		</div>
			</div>
...
<div class="container-fluid bg-trasparent my-5 p-0"> 
		<div class="row g-7"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/гамб.jpg" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
						...
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">55 рублей</span> 
						</div>
						</div> 
			</div> 
		</div> 
