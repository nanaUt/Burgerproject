...
<ul class="main-menu">
    ...
    <li class="active"><a href="http://localhost/basic/web/index.php?r=site/menudesert">Десерты</a></li>
	...
	<div class="row g-3"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/пирож.jpg" class="card-img-top" alt="...">  
							<div class="card-body"> 
						<div class="text-center my-4">
							<h5 class="card-title">Пирожок с малиной</h5> 
						</div>
						<div class="text-center my-4">
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/шок.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Торт шоколадный</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
				...
				<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/экл.jpg" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Эклер ванильный</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">69 рублей</span> 
						</div>
						</div>
			</div> 
		</div> 
	...
	<div class="container-fluid bg-trasparent my-4 p-3"> 
		<div class="row g-3"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/мак.jpeg" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Макарони (1шт)</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">49 рублей</span> 
						</div>
						</div> 
			</div> 
		</div> 
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/донат шоколадный.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Донат шоколадный</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">79 рублей</span> 
						</div>
						</div>
		</div>
			</div>
				...
				<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/донат ванильный.png" class="card-img-top" alt="...">  
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Донат ванильный</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">79 рублей</span> 
...
<div class="container-fluid bg-trasparent my-4 p-3"> 
		<div class="row g-3"> 
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/тирамис.jpg" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
						...
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">165 рублей</span> 
						</div>
						</div> 
			</div> 
		</div> 
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/чизкейк.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
