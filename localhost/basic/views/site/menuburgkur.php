	...
	<div class="container-fluid bg-trasparent my-4 p-3"> 
			...
			<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/чикен хит.png" class="card-img-top" alt="...">  
							<div class="card-body"> 
						<div class="text-center my-4">
							<h5 class="card-title">Чикен Хит</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">110 рублей</span> 
						</div>
						</div>
			</div> 
		</div> 
			  ...
			  <div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/премьер.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Чикен премьер</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
									<span class="float-start badge rounded-pill bg-success">149 рублей</span> 
						</div>
						</div>  
		</div>
			</div>
				...
				<div class="col-sm-4"> 
				<div class="card h-100 shadow-sm"> 
					<img src="images/чикенбургер.png" class="card-img-top" alt="..."> 
							<div class="card-body"> 
								<div class="text-center my-4">
							<h5 class="card-title">Чикенбургер</h5> 
						</div>
						<div class="text-center my-4">
						<div class="clearfix mb-3"> 
